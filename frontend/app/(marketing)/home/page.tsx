        ...
        <div style={{ minHeight: "100dvh", background: "#fff" }}>
            ...
            <section style={{ maxWidth: "900px", margin: "0 auto", padding: "96px 24px 80px", textAlign: "center" }}>
                ...
                <h1 style={{
                    ...
                    color: "#111", marginBottom: "24px", letterSpacing: "-0.02em",
                }}>
            ...
            <section style={{ background: "#f9fafb", padding: "80px 24px" }}>
                <div style={{ maxWidth: "800px", margin: "0 auto" }}>
                    <h2 style={{ fontSize: "32px", fontWeight: 800, color: "#111", textAlign: "center", marginBottom: "56px" }}>How it works</h2>
                        ...
                        {STEPS.map(s => (
                            <div key={s.n} style={{ display: "flex", gap: "24px", alignItems: "flex-start" }}>
                                <div style={{
                                    ...
                                    fontSize: "13px", fontWeight: 800, color: "#16a34a", fontFamily: "monospace",
                                }}>{s.n}</div>
                                <div>
            ...
            <section style={{ padding: "80px 24px", textAlign: "center" }}>
                ...
                <p style={{ fontSize: "16px", color: "#6b7280", marginBottom: "36px" }}>Free to try. No credit card required.</p>
            ...
            {/* Footer */}
            <footer style={{
                borderTop: "1px solid #e5e7eb", padding: "24px 24px",
